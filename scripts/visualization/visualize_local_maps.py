...
local_maps_folder = config['radar_data']['mars']['teach_local_maps_path']
...
out_path_folder = os.path.join(result_folder,f"mars_t1_r2/")
create_video(local_maps_folder, os.path.join(out_path_folder, "mars_local_vtr_maps.mp4"), fps=30, output_size=(4001, 4001), format='mp4')
